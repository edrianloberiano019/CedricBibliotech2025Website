        ...
        <div className=" py-10  flex flex-col   w-full">
          ...
          >
            <div
              ...
              className={`" ${
                activeBar === "bookmanagers" ? "bg-blue-700 pl-10 shadow-md" : ""
            ...
            <div
              ...
              } } text-white hover:shadow-md mt-1 rounded-md hover:bg-blue-700 hover:pl-10 font-kanit cursor-pointer transition-all px-8 py-3 w-full "`}
            >
              Book Manager
            </div>
          </div>
          ...
          <button
            ...
            } mt-9 flex mb-3 hover:pl-10 overflow-hidden w-full hover:bg-blue-700 hover:shadow-md  px-8 py-3 rounded-xl transition-all gap-6 text-xl font-kanit text-white text-left`}
          >
            <motion.div
              className=" flex flex-c gap-6"
              initial={{ x: -400, opacity: 0 }}
